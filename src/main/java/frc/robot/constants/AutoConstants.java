...
public class AutoConstants {
    ...
    public static final PathPlannerTrajectory STATION_2_PIECE_BLUE_PATH =
            PathPlanner.loadPath("Station2PieceBlue", DEFAULT_SPEED_CONSTRAINTS);
    public static final PathPlannerTrajectory STATION_2_PIECE_RED_PATH =
            PathPlanner.loadPath("Station2PieceRed", DEFAULT_SPEED_CONSTRAINTS);

    public static final PathPlannerTrajectory MOVE_ONE_METER =
            PathPlanner.loadPath("MoveOneMeter", DEFAULT_SPEED_CONSTRAINTS);
