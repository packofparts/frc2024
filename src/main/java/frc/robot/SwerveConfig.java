...
public class SwerveConfig {
    ...
    public static SwerveModule frontRightModule = new SwerveModule(frontRightRotID,
            frontRightTransID, frontRightRotEncoderID, SwerveConstants.frontRightRotEncoderOffset,
            frontRightRotInverse, frontRightTransInverse, frontRightRotPID);

    public static SwerveModule frontLeftModule = new SwerveModule(frontLeftRotID, frontLeftTransID,
            frontLeftRotEncoderID, SwerveConstants.frontLeftRotEncoderOffset, frontLeftRotInverse,
            frontLeftTransInverse, frontLeftRotPID);

    public static SwerveModule backRightModule = new SwerveModule(backRightRotID, backRightTransID,
            backRightRotEncoderID, SwerveConstants.backRightRotEncoderOffset, backRightRotInverse,
    ...
    public static SwerveModule backLeftModule = new SwerveModule(backLeftRotID, backLeftTransID,
            backLeftRotEncoderID, SwerveConstants.backLeftRotEncoderOffset, backLeftRotInverse,
            backLeftTransInverse, backLeftRotPID);
